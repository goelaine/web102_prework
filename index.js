...
function addGamesToPage(games) {
    ...
    // Step 1: Loop over each game in the games array
    for (let i = 0; i < games.length; i++) {
        const game = games[i];

        // Step 2: Create a new div and add the class 'game-card'
        ...
        // Step 4: Append the card to the games container
...
console.log("first game:", topGame.name)
